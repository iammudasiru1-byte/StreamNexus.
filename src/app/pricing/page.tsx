                ...
                <tr>
                  ...
                  {PRICING.map(p => (
                    <td key={p.id} style={{ padding:'1.25rem',textAlign:'center' }}>
                      <Link href={`/apply?plan=${p.id}`} className={p.badge ? 'btn-plan-primary' : 'btn-plan-outline'} style={{ display:'inline-block', textAlign:'center' }}>
                        ${p.price} →
                      </Link>
                    </td>
                  ))}
                  ...
                  {plat.streamers.map((s, si) => {
                    ...
                    return (
                      <StreamerCard
                        ...
                        live={false}
                        href={
                          plat.name === 'Twitch' ? `https://twitch.tv/${s.handle}`
                          : plat.name === 'YouTube' ? `https://youtube.com/@${s.handle}`
                          : plat.name === 'Kick' ? `https://kick.com/${s.handle}`
                          : `https://tiktok.com/@${s.handle}`
                        }
                        platformColor={plat.color}
                        platformBorder={plat.border}
                      />
                    )
                  })}
                </div>
